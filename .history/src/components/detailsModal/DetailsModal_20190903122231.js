...
const DetailsModal = () => {
  ...
  const { foodItem, foodItemClicked, nutrientInfo } = foodContext;
  ...
  }, [setIcon, setFoodName, foodItem, foodItemClicked, foodName, nutrientInfo]);
    ...
    <div>
      ...
      >
        ...
        >
          ...
          <div style={{ marginLeft: "20px", marginBottom: "2rem" }}>slice</div>
