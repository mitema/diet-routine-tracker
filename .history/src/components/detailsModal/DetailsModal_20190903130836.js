...
const DetailsModal = () => {
  ...
  const [servingsQty, setServingQty] = useState("");
  ...
  useEffect(() => {
    if (foodItemClicked) {
      if (nutrientInfo) {
        ...
        setServingUnit(nutrientInfo.foods[0].serving_unit);
        setFoodGrams(nutrientInfo.foods[0].serving_weight_grams);
        setFoodCalories(nutrientInfo.foods[0].nf_calories);
